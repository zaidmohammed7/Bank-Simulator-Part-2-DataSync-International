...
class Calendar:
    ...
    def __init__(self):
        ...
        def refresh():
            self.wn.destroy()
            from main_directory.refresh_windows_functions_file import refresh_calendar__utils__
            refresh_calendar__utils__()
        ...
        self.wn.bind('<Control-r>', refresh__fn)
        self.wn.bind('<Alt-h>', return_home__fn)
