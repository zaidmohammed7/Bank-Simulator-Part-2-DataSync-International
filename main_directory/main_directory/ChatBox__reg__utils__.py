...
pop_out_chat_box_list = []


class ChatApplicationWn:

    def __init__(self):

        super(ChatApplicationWn, self).__init__()
        ...
        def refresh():
            self.root.destroy()
            from main_directory.refresh_windows_functions_file import refresh_chat__utils__
            refresh_chat__utils__()
